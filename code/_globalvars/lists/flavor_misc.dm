...
GLOBAL_LIST_EMPTY(teshari_tailfeathers_list)
GLOBAL_LIST_EMPTY(teshari_footfeathers_list)
GLOBAL_LIST_EMPTY(teshari_handfeathers_list)
GLOBAL_LIST_EMPTY(teshari_modeyes_list)
