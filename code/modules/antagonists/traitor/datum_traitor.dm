...
/datum/antagonist/traitor/on_gain()
	...
	if(traitor_kind == TRAITOR_HUMAN) //DONKSTATION CHANGE: traitors get a syndicate faction
...
/datum/antagonist/traitor/proc/finalize_traitor()
	switch(traitor_kind)
		...
		if(TRAITOR_HUMAN)
			...
			if(should_equip)
				equip(silent)
			var/obj/item/implant/radio/syndicate/I = new /obj/item/implant/radio/syndicate/limited() //DONKSTATION CHANGE: gives traitors syndicate radio implants on roundstart
...
/datum/antagonist/traitor/roundend_report()
	...
	if(synd_faction && synd_faction_name && !(synd_faction & SYND_FACTION_SYND)) //DONKSTATION CHANGE: traitors get a syndicate faction
